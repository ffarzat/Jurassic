...
namespace UnitTests
{
    ...
    public class RealWorldTests
    {
        ...
        public void Showdown()
        {
            ...
            engine.ExecuteFile(@"D:\GitHub\Jurassic\Unit Tests\Real-world\Files\showdown.js");
        ...
        public void ColorConversion()
        {
            ...
            var engine = new ScriptEngine();
            engine.ExecuteFile(@"D:\GitHub\Jurassic\Unit Tests\Real-world\Files\color-conversion.js");
        ...
        public void sprintf()
        {
            ...
            var engine = new ScriptEngine();
            engine.ExecuteFile(@"D:\GitHub\Jurassic\Unit Tests\Real-world\Files\sprintf.js");
        ...
        public void MD5()
        {
            ...
            var engine = new ScriptEngine();
            engine.ExecuteFile(@"D:\GitHub\Jurassic\Unit Tests\Real-world\Files\md5.js");
        ...
        public void SHA1()
        {
            ...
            var engine = new ScriptEngine();
            engine.ExecuteFile(@"D:\GitHub\Jurassic\Unit Tests\Real-world\Files\sha1.js");
        ...
        public void SHA256()
        {
            ...
            var engine = new ScriptEngine();
            engine.ExecuteFile(@"D:\GitHub\Jurassic\Unit Tests\Real-world\Files\sha256.js");
        ...
        public void LZW()
        {
            ...
            var engine = new ScriptEngine();
            engine.ExecuteFile(@"D:\GitHub\Jurassic\Unit Tests\Real-world\Files\lzw.js");
        ...
        public void RSAEncrypt()
        {
            ...
            engine.ExecuteFile(@"D:\GitHub\Jurassic\Unit Tests\Real-world\Files\rsa.js");
            engine.Execute(@"
                var rsa = new RSAKey();
        ...
        public void Levenshtein()
        {
            ...
            var engine = new ScriptEngine();
            engine.ExecuteFile(@"D:\GitHub\Jurassic\Unit Tests\Real-world\Files\levenshtein.js");
        ...
        public void CoffeeScript()
        {
            ...
            var engine = new ScriptEngine();
            engine.ExecuteFile(@"D:\GitHub\Jurassic\Unit Tests\Real-world\Files\coffee-script.js");
